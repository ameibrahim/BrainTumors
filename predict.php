...
<body>
    ...
    <div class="predict-main-container main-container normal-margin">
        ...
        <div class="min-max-wrapper">
            <div class="instructions">
                ...
                <ol>
                    <li>Click the <highlight>Perform Brain Tumor Prediction</highlight> button</li>
            ...
            <div class="stretchxy-container">
                <div class="predict-button-container">
                    <div class="button" onclick="handlePredictContainerView()">Perform Brain Tumor Prediction</div>
                </div>
            </div>
        </div>
    ...
    <?php include "components/asyncPredictionOverlay.php" ?>
